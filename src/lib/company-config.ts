...
export const COMPANY_CONFIG = {
  ...
  products: {
    connect: process.env.NEXT_PUBLIC_PRODUCT_CONNECT || `${process.env.NEXT_PUBLIC_COMPANY_NAME || 'Fund Deck'} Connect`,
    spaces: process.env.NEXT_PUBLIC_PRODUCT_SPACES || `${process.env.NEXT_PUBLIC_COMPANY_NAME || 'Fund Deck'} Spaces`,
    enterprise: process.env.NEXT_PUBLIC_PRODUCT_ENTERPRISE || `${process.env.NEXT_PUBLIC_COMPANY_NAME || 'Fund Deck'} Enterprise`,
  },
  
  // Platform title for meta tags
  platformTitle: process.env.NEXT_PUBLIC_PLATFORM_TITLE || `${process.env.NEXT_PUBLIC_COMPANY_NAME || 'Fund Deck'} - Investor Pitch Deck Template`,
  platformDescription: process.env.NEXT_PUBLIC_PLATFORM_DESCRIPTION || "Professional investor presentation template for startups",
  
  // Admin panel description
  adminDescription: process.env.NEXT_PUBLIC_ADMIN_DESCRIPTION || `Manage content across all pages of the ${process.env.NEXT_PUBLIC_COMPANY_NAME || 'Fund Deck'} investor platform`,
} as const
